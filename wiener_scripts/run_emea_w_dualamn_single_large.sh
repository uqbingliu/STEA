#!/bin/bash
#SBATCH --job-name=single_dualamn_large
#SBATCH --output=wiener_logs/single_dualamn_large.out
#SBATCH --error=wiener_logs/single_dualamn_large.err
...
#  for train_percent in 0.1
  do
    task="overall_perf_dualamn_single_${train_percent}_${joint_distr_thr}_${direction}_seed${seed}"
