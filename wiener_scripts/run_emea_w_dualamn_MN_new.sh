#!/bin/bash
#SBATCH --job-name=mutnearest_dualamn_new
#SBATCH --output=wiener_logs/mutnearest_dualamn_new.out
#SBATCH --error=wiener_logs/mutnearest_dualamn_new.err
...
#  for train_percent in 0.01
  do
    task="overall_perf_dualamn_mutnearest_new_${initial_training}_${train_percent}_seed${seed}_debug"
