#!/bin/bash
#SBATCH --job-name=single_alinet
#SBATCH --output=wiener_logs/single_alinet.out
#SBATCH --error=wiener_logs/single_alinet.err
...
#  for train_percent in 0.01
  do
    task="overall_perf_alinet_single_${initial_training}_${train_percent}_${joint_distr_thr}_seed${seed}"
