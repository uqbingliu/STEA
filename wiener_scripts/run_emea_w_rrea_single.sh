#!/bin/bash
#SBATCH --job-name=single_rrea
#SBATCH --output=wiener_logs/single_rrea.out
#SBATCH --error=wiener_logs/single_rrea.err
...
#  for train_percent in 0.01
  do
    task="overall_perf_rrea_single_${train_percent}_${joint_distr_thr}_${direction}_seed${seed}"
