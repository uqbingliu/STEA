#!/bin/bash
#SBATCH --job-name=mn_alinet
#SBATCH --output=wiener_logs/mn_alinet.out
#SBATCH --error=wiener_logs/mn_alinet.err
...
#  for train_percent in 0.01
  do
    task="overall_perf_alinet_mutnearest_${initial_training}_${train_percent}_seed${seed}"
