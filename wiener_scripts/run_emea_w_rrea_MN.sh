#!/bin/bash
#SBATCH --job-name=mutnearest
#SBATCH --output=wiener_logs/mutnearest.out
#SBATCH --error=wiener_logs/mutnearest.err
...
for data_name in "ja_en" "fr_en"
do
  for train_percent in 0.01 0.05 0.1 0.2 0.3
#  for train_percent in 0.01
  do
    task="overall_perf_rrea_mutnearest_${initial_training}_${train_percent}_seed${seed}"
