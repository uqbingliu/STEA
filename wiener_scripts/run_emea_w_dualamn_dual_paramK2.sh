#!/bin/bash
#SBATCH --job-name=dual_amn_k2
#SBATCH --output=wiener_logs/dual_amn_k2.out
#SBATCH --error=wiener_logs/dual_amn_k2.err
...
#  for train_percent in 0.01
  do
    task="overall_perf_dualamn_dual_paramK${topK}_${train_percent}_seed${seed}"
