#!/bin/bash
#SBATCH --job-name=rrea_single
#SBATCH --output=wiener_logs/rrea_single.out
#SBATCH --error=wiener_logs/rrea_single.err
...
#  for train_percent in 0.01 0.05 0.1 0.2 0.3
  ...
  do
    task="overall_perf_rrea_${initial_training}_${continue_training}_${train_percent}_seed${seed}"
