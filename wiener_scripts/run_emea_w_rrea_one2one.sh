#!/bin/bash
#SBATCH --job-name=one2one_rrea
#SBATCH --output=wiener_logs/one2one_rrea.out
#SBATCH --error=wiener_logs/one2one_rrea.err
...
#  for train_percent in 0.01
  do
    task="overall_perf_rrea_onetoone_${initial_training}_${train_percent}_seed${seed}"
