#!/bin/bash
#SBATCH --job-name=simthr_dualamn
#SBATCH --output=wiener_logs/simthr_dualamn.out
#SBATCH --error=wiener_logs/simthr_dualamn.err
...
for data_name in "ja_en"
do
#  for train_percent in 0.01 0.05 0.1 0.2 0.3
  for train_percent in 0.01 0.05 0.1 0.2 0.3
  do
    task="overall_perf_dualamn_simthr_${initial_training}_${train_percent}_${neural_thr}_${direction}_seed${seed}"
