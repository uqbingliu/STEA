...
#SBATCH --output=wiener_logs/norm.out
#SBATCH --error=wiener_logs/norm.err
...
#  for train_percent in 0.01
  do
    task="overall_perf_dual_amn_simpleNorm_${initial_training}_${train_percent}_seed${seed}"
    ...
    --no_joint_distr=${no_joint_distr} --direction=${direction} --no_sim2prob=${no_sim2prob}
