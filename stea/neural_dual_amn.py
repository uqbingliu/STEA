...
from stea.Dual_AMN.runner import Runner
import subprocess
...
class DualAMNModule(NeuralEAModule):
    ...
    def train_model_with_observed_labels(self):
        print("py_exe_fn", self.conf.py_exe_fn)
    ...
    def enhance_latent_labels_with_jointdistr_old(self, improved_candi_probs: torch.Tensor, candi_mtx):
        kg1id, kg2id = self.conf.data_name.split("_")
