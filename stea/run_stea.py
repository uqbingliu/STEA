...
from stea.stea_framework import STEAFramework
import os
...
parser.add_argument('--tf_device', default="1", type=str)
...
parser.add_argument('--direction', default="both", type=str)
...
em_framework = STEAFramework(conf=conf, jointdistr_model=joint_distr_model, jointdistr_model_inv=joint_distr_model_inv, neural_ea_model=neural_ea_model)
em_framework.run_EM()
