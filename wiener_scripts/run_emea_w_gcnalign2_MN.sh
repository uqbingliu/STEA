#!/bin/bash
#SBATCH --job-name=mutnearest_gcn
#SBATCH --output=wiener_logs/mutnearest_gcn.out
#SBATCH --error=wiener_logs/mutnearest_gcn.err
...
#  for train_percent in 0.01
  do
    task="overall_perf_gcnalign2_mutnearest_${initial_training}_${train_percent}_seed${seed}"
