#!/bin/bash
#SBATCH --job-name=dual_amn
#SBATCH --output=wiener_logs/dual_amn.out
#SBATCH --error=wiener_logs/dual_amn.err
...
#  for train_percent in 0.01
  do
    task="overall_perf_dualamn_dual_${train_percent}_seed${seed}_debug"
