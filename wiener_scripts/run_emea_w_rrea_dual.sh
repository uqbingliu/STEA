#!/bin/bash
#SBATCH --job-name=dual_rrea
#SBATCH --output=wiener_logs/dual_rrea.out
#SBATCH --error=wiener_logs/dual_rrea.err
...
#  for train_percent in 0.01
  do
    task="overall_perf_rrea_dual_${train_percent}_seed${seed}"
