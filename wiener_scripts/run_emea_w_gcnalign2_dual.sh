#!/bin/bash
#SBATCH --job-name=dual_gcn
#SBATCH --output=wiener_logs/dual_gcn.out
#SBATCH --error=wiener_logs/dual_gcn.err
...
#  for train_percent in 0.3
  do
    task="overall_perf_gcnalign2_dual_${train_percent}_seed${seed}"
