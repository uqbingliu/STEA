#!/bin/bash
#SBATCH --job-name=simthr-0.5
#SBATCH --output=wiener_logs/simthr-0.5.out
#SBATCH --error=wiener_logs/simthr-0.5.err
...
#  for train_percent in 0.01
  do
    task="overall_perf_rrea_simthr_${initial_training}_${train_percent}_${neural_thr}_seed${seed}"
