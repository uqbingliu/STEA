...
#  for train_percent in 0.01 0.05 0.1 0.2 0.3
  ...
  do
    task="overall_perf_gcnalign_mutnearest_${initial_training}_${train_percent}_seed${seed}"
    ...
    --openea_script_fn=${openea_script_fn} --openea_arg_fn=${openea_arg_fn} --ea_model=openea"
    echo $params
