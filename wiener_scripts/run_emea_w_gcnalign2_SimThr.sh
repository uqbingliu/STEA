#!/bin/bash
#SBATCH --job-name=simthr_gcn
#SBATCH --output=wiener_logs/simthr_gcn.out
#SBATCH --error=wiener_logs/simthr_gcn.err
...
#  for train_percent in 0.01 0.05 0.1 0.2 0.3
  for train_percent in 0.01 0.05 0.1 0.2 0.3
  do
    task="overall_perf_gcnalign2_simthr_${initial_training}_${train_percent}_${neural_thr}_${direction}_seed${seed}"
