#!/bin/bash
#SBATCH --job-name=one2one_dualamn
#SBATCH --output=wiener_logs/one2one_dualamn.out
#SBATCH --error=wiener_logs/one2one_dualamn.err
...
#  for train_percent in 0.01
  do
    task="overall_perf_dualamn_onetoone_${initial_training}_${train_percent}_seed${seed}_pseudoquality"
