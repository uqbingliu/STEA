...
neural_one2one=False
joint_distr_one2one=True
neural_thr=0
joint_distr_thr=0
neural_mn=False
joint_distr_mn=True
...
#  for train_percent in 0.01 0.05 0.1 0.2 0.3
  ...
  do
    ...
    --no_joint_distr=${no_joint_distr} --neural_one2one=${neural_one2one} --joint_distr_one2one=${joint_distr_one2one} --direction=${direction}
