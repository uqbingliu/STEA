#!/bin/bash
#SBATCH --job-name=dual_alinet
#SBATCH --output=wiener_logs/dual_alinet.out
#SBATCH --error=wiener_logs/dual_alinet.err
...
#  for train_percent in 0.01
  do
    task="overall_perf_alinet_dual_${initial_training}_${train_percent}_seed${seed}"
