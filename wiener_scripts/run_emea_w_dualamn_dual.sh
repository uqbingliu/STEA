#!/bin/bash
#SBATCH --job-name=dual_dualamn
#SBATCH --output=wiener_logs/dual_dualamn.out
#SBATCH --error=wiener_logs/dual_dualamn.err
...
#  for train_percent in 0.01
  do
    task="overall_perf_dualamn_dual_${train_percent}_seed${seed}"
