#!/bin/bash
#SBATCH --job-name=simthr_alinet
#SBATCH --output=wiener_logs/simthr_alinet.out
#SBATCH --error=wiener_logs/simthr_alinet.err
...
#  for train_percent in 0.01
  do
    task="overall_perf_alinet_simthr_${initial_training}_${train_percent}_${neural_thr}_seed${seed}"
    ...
    --direction=${direction} --no_joint_distr=${no_joint_distr}
